...
async function modalContentRender(id) {
  ...
  const departamentDescription = document.querySelector(
...
async function dismissEmployee() {
  ...
  btnDismiss.forEach((btn) => {
    btn.addEventListener("click", async (e) => {
      ...
      modalText.innerText = `Realmente deseja demitir o usuário ${e.target.name}`;
      ...
      btnRemove.addEventListener("click", async (e) => {
        ...
        toast("Usuario demitido com sucesso", "red");
        modalConfirm.close();
      });
    });
